...
| 页面 | 模块 | 功能描述 |
|------|------|----------|
| 首页 | 压缩面板 | 文本输入框、文件拖拽上传区、格式选择（ZIP/GZIP/DEFLATE/LZMA）、压缩按钮、下载结果 |
...
4. 浏览器本地执行压缩算法
5. 展示压缩统计
6. 用户下载输出文件（ZIP/GZIP/DEFLATE/LZMA 对应扩展名）
...
- **主色**：深灰 `#0d0d0d` 背景，亮黄 `#f2c94c` 作为强调色，米白 `#f4f4f0` 作为文字色
